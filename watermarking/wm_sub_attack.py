...
def main(args: WmLMArgs):
    ...
    path = '/ailab/user/jianghaoyu/MWM/my_watermark_result/lm_new_7_10/huggyllama-llama-7b_5.5_1.5_300_170_20_42_42_10_16_4_1.0_10_-1_200_max_confidence_updated_0.5_huggyllama/llama-7b_1000.json'
    import json
    ...
    lm_message_model = LMMessageModel_update(tokenizer=tokenizer, lm_model=lm_model,
                                      lm_tokenizer=tokenizer,
                                      delta=5.5, lm_prefix_len=10, lm_topk=-1, message_code_len=10,
                                      random_permutation_num=200)
    wm_precessor_message_model = WmProcessorMessageModel_update(message_model=lm_message_model,
                                                         tokenizer=tokenizer,
