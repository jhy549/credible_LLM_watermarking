...
### Generation ###
export MODEL_PATH="huggyllama/llama-7b"; export BS=1; export TOKEN_LEN=200;
...
## multi-bit
export MSG_LEN=12; export RADIX=4; export ZERO_BIT=F;
...
export ORACLE_MODEL="huggyllama/llama-13b"
export IGNORE_R_NGRAM=T
export EVAL_METRICS="ppl"
