...
def main(args: WmLMArgs, control_args: RunControlArgs):
    ...
    path = './my_watermark_result/lm_new_7_10/huggyllama-llama-7b_1.5_1.5_300_200_200_42_42_20_10_4_1.0_10_-1_300_max_confidence_updated_0.5_huggyllama/llama-7b_1000_my.json'
    import json
    ...
    lm_model = AutoModelForCausalLM.from_pretrained("huggyllama/llama-7b" ,device_map="auto")
